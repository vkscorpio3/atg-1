			...
			<div class="row">
				<div class="col-sm-6 new-users">
					...
					<div class="buttons-set">
						<button class="button" onclick="window.location='/dwellstore/account/register.jsp';" title="Create an Account" type="button">
							<span>
						...
						<ul class="form-list">
							...
							<li>
								...
								<div class="input-box">
            						...
            						<dsp:input bean="/atg/userprofiling/ProfileFormHandler.loginSuccessURL" type="hidden" value="${originatingRequest.contextPath}"/>
								</div>
							</li>
						</ul>
					</div>
					<div class="buttons-set">
						<a class="f-left" href="/dwellstore/account/forgotpassword.jsp">Forgot Your Password?</a>
