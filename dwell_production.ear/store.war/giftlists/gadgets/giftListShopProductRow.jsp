      ...
      <tr class="<crs:listClass count="${count}" size="${size}" selected="false"/>">
        ...
        <td class="quantity">
          ...
          <c:choose>
            ...
            <c:otherwise>
              <dsp:form class="addToCart" formid="addToCart"
                ...
                <dsp:input bean="CartModifierFormHandler.quantity" type="text" value="0" size="2"
                           iclass="qty atg_store_numericInput" title="${atg_store_qtyInputTitle}"/>
...
<%-- @version $Id: //hosting-blueprint/B2CBlueprint/version/11.2/Storefront/j2ee/store.war/giftlists/gadgets/giftListShopProductRow.jsp#2 $$Change: 1179550 $--%>
