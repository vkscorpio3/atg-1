...
<dsp:page>
  ...
  <div class="atg_store_main">
    ...
    <dsp:droplet name="StoreText">
      <dsp:param name="key" value="companyTermsList"/>
      ...
      <dsp:oparam name="output">
        ...
        <%-- 
          Each item is a list of messages: first one is the title and others are
          the content. Use the droplet one more time to get this messages.      
        --%>     
        <dsp:droplet name="StoreText">
...
<%-- @version $Id: //hosting-blueprint/B2CBlueprint/version/11.2/Storefront/j2ee/store.war/company/terms.jsp#1 $$Change: 946917 $--%>
