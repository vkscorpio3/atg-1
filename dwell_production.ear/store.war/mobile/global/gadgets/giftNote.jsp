...
<dsp:page>
  ...
  <c:if test='${containsGiftMessage == "true"}'>
    ...
    <div class="item">
      ...
      <div class="thumbnail">
        <img src="/crsdocroot/content/images/GN_GiftNote.jpg" alt="<fmt:message key="mobile.order.label.giftNote"/>">
      </div>
...
<%-- @version $Id: //hosting-blueprint/B2CBlueprint/version/11.2/Storefront/j2ee/store.war/mobile/global/gadgets/giftNote.jsp#2 $$Change: 953229 $--%>
