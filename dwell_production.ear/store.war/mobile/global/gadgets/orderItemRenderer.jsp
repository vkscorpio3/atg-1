        ...
        <c:choose>
          <c:when test="${not empty productUrl && not isCheckout}">
            ...
            <dsp:a href="${fn:escapeXml(productUrl)}">
              <dsp:valueof param="currentItem.auxiliaryData.catalogRef.displayName">
...
<%-- @version $Id: //hosting-blueprint/B2CBlueprint/version/11.2/Storefront/j2ee/store.war/mobile/global/gadgets/orderItemRenderer.jsp#1 $$Change: 946917 $--%>
