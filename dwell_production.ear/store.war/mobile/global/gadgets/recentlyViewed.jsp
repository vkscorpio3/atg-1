  ...
  <dsp:droplet name="RecentlyViewedFilterDroplet">
    ...
    <dsp:oparam name="output">
      <div class="sliderTitle">
        <fmt:message key="mobile.common.header.recentlyViewedItems"/>
      </div>
...
<%-- @version $Id: //hosting-blueprint/B2CBlueprint/version/11.2/Storefront/j2ee/store.war/mobile/global/gadgets/recentlyViewed.jsp#1 $$Change: 946917 $--%>
