      ...
      <c:choose>
        ...
        <c:otherwise>
          ...
          <details ${RegOpenState}>
            ...
            <div class="expandedSignUpContainer">
...
<%-- @version $Id: //hosting-blueprint/B2CBlueprint/version/11.2/Storefront/j2ee/store.war/mobile/global/login.jsp#1 $$Change: 946917 $--%>
