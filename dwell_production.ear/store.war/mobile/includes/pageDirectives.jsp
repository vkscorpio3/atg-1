...
<%--
  ...
  by JSP directives (as described here http://java.sun.com/developer/technicalArticles/J2EE/jsp_21/)
  when the HTML is rendered. 
--%>
<%@page trimDirectiveWhitespaces="true"%>
<%-- @version $Id: //hosting-blueprint/B2CBlueprint/version/11.2/Storefront/j2ee/store.war/mobile/includes/pageDirectives.jsp#1 $$Change: 946917 $--%>
