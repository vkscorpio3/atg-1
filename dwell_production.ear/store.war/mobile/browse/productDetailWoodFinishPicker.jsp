        ...
        <dsp:oparam name="output">
          <dsp:droplet name="WoodFinishDroplet">
            ...
            <dsp:oparam name="error">
              <dsp:include page="../global/serverError.jsp"/>
            </dsp:oparam>
          </dsp:droplet>
        </dsp:oparam>
      </dsp:droplet>
...
<%-- @version $Id: //hosting-blueprint/B2CBlueprint/version/11.2/Storefront/j2ee/store.war/mobile/browse/productDetailWoodFinishPicker.jsp#2 $$Change: 953229 $--%>
