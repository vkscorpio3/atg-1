...
<dsp:page>
  ...
  <label for="${id}" class="noText" onclick="">
    <span class="qtyLabelText"><fmt:message key="mobile.common.quantity"/><fmt:message key="mobile.common.colon"/></span>
...
<%-- @version $Id: //hosting-blueprint/B2CBlueprint/version/11.2/Storefront/j2ee/store.war/mobile/browse/gadgets/quantityPickerList.jsp#1 $$Change: 946917 $--%>
