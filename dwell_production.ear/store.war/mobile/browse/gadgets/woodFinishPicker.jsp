...
<dsp:page>
  <li>
    <fmt:message key="mobile.common.label.woodFinish" var="finishLabel"/>
...
<%-- @version $Id: //hosting-blueprint/B2CBlueprint/version/11.2/Storefront/j2ee/store.war/mobile/browse/gadgets/woodFinishPicker.jsp#1 $$Change: 946917 $--%>
