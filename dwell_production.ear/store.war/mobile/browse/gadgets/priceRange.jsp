      ...
      <p>
        <dsp:droplet name="Compare">
          ...
          <dsp:oparam name="default">
            <fmt:message key="mobile.productDetails.priceFrom"/><br/><strong>
              <dsp:include page="/global/gadgets/formattedPrice.jsp">
                <dsp:param name="price" value="${lowestPrice}"/>
              </dsp:include>
            </strong><br/><fmt:message key="mobile.productDetails.priceTo"/>
            <br/><strong>
              <dsp:include page="/global/gadgets/formattedPrice.jsp">
        ...
        <c:if test="${showSalePrice}">
          <br/><fmt:message key="mobile.common.priceWas"/>
          <dsp:droplet name="Compare">
            ...
            <dsp:oparam name="default">
              ...
              <fmt:message key="mobile.common.hyphen"/>
              <span>
                <dsp:include page="/global/gadgets/formattedPrice.jsp">
...
<%-- @version $Id: //hosting-blueprint/B2CBlueprint/version/11.2/Storefront/j2ee/store.war/mobile/browse/gadgets/priceRange.jsp#1 $$Change: 946917 $--%>
