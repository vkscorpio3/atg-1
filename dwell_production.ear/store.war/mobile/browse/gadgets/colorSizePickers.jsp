...
<dsp:page>
  ...
  <c:if test="${fn:length(availableColors) > 0}">
    <li>
      <fmt:message key="mobile.common.label.color" var="colorLabel"/>
  ...
  <c:if test="${fn:length(availableSizes) > 0}">
    <li>
      <fmt:message key="mobile.common.label.size" var="sizeLabel"/>
      <dsp:include page="pickerList.jsp">
...
<%-- @version $Id: //hosting-blueprint/B2CBlueprint/version/11.2/Storefront/j2ee/store.war/mobile/browse/gadgets/colorSizePickers.jsp#1 $$Change: 946917 $--%>
