      ...
      <c:choose>
        ...
        <c:otherwise>
          ...
          <img src="${promotionalContent.derivedDeviceImage}" alt="${promotionalContent.storeDisplayName}"
               class="homePromotionalImage"/>
        </c:otherwise>
      </c:choose>
    </div>
  </div>
</dsp:page>
<%-- @version $Id: //hosting-blueprint/B2CBlueprint/version/11.2/Storefront/j2ee/store.war/mobile/promo/gadgets/homePagePromotionalCell.jsp#3 $$Change: 1179550 $--%>
