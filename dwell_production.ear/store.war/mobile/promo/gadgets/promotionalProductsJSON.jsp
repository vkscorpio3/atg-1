<%--
  Renders promotional product details JSON.
...
<dsp:page>
  ...
  <json:object>
    ...
    <dsp:droplet name="SiteIdForCatalogItem" item="${product}" var="siteIdForCatalogItem">
      ...
      <%-- Search through the mobile (!) sites which belong to "crs.MobileSite" shareable type --%>
...
<%-- @version $Id: //hosting-blueprint/B2CBlueprint/version/11.2/Storefront/j2ee/store.war/mobile/promo/gadgets/promotionalProductsJSON.jsp#1 $$Change: 946917 $--%>
