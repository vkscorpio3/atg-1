<%--
  Returns products JSON, if "Recommendations" module is NOT installed.
...
<%-- @version $Id: //hosting-blueprint/B2CBlueprint/version/11.2/Storefront/j2ee/store.war/mobile/promo/gadgets/homeNoRecsProductsJSON.jsp#1 $$Change: 946917 $--%>
