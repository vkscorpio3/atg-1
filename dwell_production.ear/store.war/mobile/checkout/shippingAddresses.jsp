  ...
  <crs:mobilePageContainer titleString="${pageTitle}">
    <jsp:body>
      <div class="dataContainer">
        <h2><fmt:message key="mobile.checkout.header.shippingAddress"/></h2>
              ...
              <li>
                ...
                <div class="content">
                  ...
                  <c:if test="${!(fn:startsWith(description, giftPrefix))}">
                    ...
                    <fmt:message var="editText" key="mobile.checkout.link.edit"/>
        ...
        <script>
          $(document).ready(function() {
            CRSMA.common.delayedSubmitSetup("#savedAddresses");
          });
        </script>
      </div>
    </jsp:body>
...
<%-- @version $Id: //hosting-blueprint/B2CBlueprint/version/11.2/Storefront/j2ee/store.war/mobile/checkout/shippingAddresses.jsp#1 $$Change: 946917 $--%>
