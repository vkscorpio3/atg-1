  ...
  <crs:mobilePageContainer titleString="${pageTitle}">
    <jsp:body>
      <div class="dataContainer">
        <h2><fmt:message key="mobile.checkout.header.shippingMethod"/></h2>
                        ...
                        <li>
                          <div class="content icon-ArrowRight">
                            ...
                            <label for="shipping_${shippingMethod}" onclick="">
                              ...
                              <span class="shippingMethodTitle"><fmt:message key="${shippingMethodResourceKey}"/><fmt:message key="mobile.common.colon"/></span>
      ...
      <script>
        $(document).ready(function() {
          CRSMA.common.delayedSubmitSetup("#shippingMethods");
        });
      </script>
    </jsp:body>
  </crs:mobilePageContainer>
</dsp:page>
<%-- @version $Id: //hosting-blueprint/B2CBlueprint/version/11.2/Storefront/j2ee/store.war/mobile/checkout/shippingMethod.jsp#1 $$Change: 946917 $--%>
