  ...
  <div class="cartContainer">
    ...
    <dsp:form action="${siteContextPath}/cart/cart.jsp" method="post" name="cartContent" formid="cartContent">
      ...
      <div class="cartCheckout">
        <fmt:message var="checkoutText" key="mobile.cart.button.checkout"/>
        <dsp:input class="mainActionButton" type="submit" bean="CartModifierFormHandler.checkout" value="${checkoutText}"/>
      </div>
    </dsp:form>
  </div>
</dsp:page>
<%-- @version $Id: //hosting-blueprint/B2CBlueprint/version/11.2/Storefront/j2ee/store.war/mobile/cart/cartContent.jsp#1 $$Change: 946917 $ --%>
