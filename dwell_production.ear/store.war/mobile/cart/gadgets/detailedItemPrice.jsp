        ...
        <c:choose>
          ...
          <c:when test="${listPrice != unitPriceBean.unitPrice}">
            ...
            <span ${fn:length(formattedPrice) > 6 ? 'class="longPrice"' : ''}>
              ...
              <span>
                <fmt:message key="mobile.common.price.atRateOf"/>
              </span>
...
<%-- @version $Id: //hosting-blueprint/B2CBlueprint/version/11.2/Storefront/j2ee/store.war/mobile/cart/gadgets/detailedItemPrice.jsp#1 $$Change: 946917 $--%>
