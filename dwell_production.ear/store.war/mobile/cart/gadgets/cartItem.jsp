...
<dsp:page>
  ...
  <dsp:getvalueof var="productDisplayName" vartype="java.lang.String" param="currentItem.auxiliaryData.catalogRef.displayName"/>
  <c:if test="${empty productDisplayName}">
    <fmt:message var="productDisplayName" key="mobile.productDetails.message.noDisplayName"/>
  </c:if>
  ...
  <c:if test="${not empty productUrl}">
    ...
    <%-- "Subject" --%>
    <fmt:message var="emailSubject" key="mobile.cart.emailAFriend.emailSubject">
    ...
    <fmt:message var="emailBody" key="mobile.cart.emailAFriend.emailBody">
...
<%-- @version $Id: //hosting-blueprint/B2CBlueprint/version/11.2/Storefront/j2ee/store.war/mobile/cart/gadgets/cartItem.jsp#1 $$Change: 946917 $--%>
