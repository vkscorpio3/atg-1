...
<dsp:page>
  ...
  <div class="couponCode">
    ...
    <fmt:message var="promotionCode" key="mobile.cart.input.placeholder.promotionCode"/>
    <c:choose>
...
<%-- @version $Id: //hosting-blueprint/B2CBlueprint/version/11.2/Storefront/j2ee/store.war/mobile/cart/gadgets/promotionCode.jsp#1 $$Change: 946917 $--%>
