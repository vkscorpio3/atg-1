      ...
      <dsp:droplet name="ReturnRequestLookup">
        ...
        <dsp:oparam name="output">
          ...
          <div class="dataContainer">
            <ul class="dataList">
              <c:forEach items="${returns}" var="returnRequestObj">
                <dsp:param name="returnRequest" value="${returnRequestObj}"/>
                <li>
...
<%-- @version $Id: //hosting-blueprint/B2CBlueprint/version/11.2/Storefront/j2ee/store.war/mobile/myaccount/myReturns.jsp#2 $$Change: 953229 $--%>
