...
<dsp:page>
  ...
  <div class="creditCardLabelValueContainer">
	  <div class="label creditCardLabel">
	  ...
	  <div class="value creditCardValue">
...
<%-- @version $Id: //hosting-blueprint/B2CBlueprint/version/11.2/Storefront/j2ee/store.war/mobile/myaccount/gadgets/creditCard.jsp#2 $$Change: 953229 $--%>
