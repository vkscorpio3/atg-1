...
<dsp:page>
  ...
  <c:if test="${not empty promotionAdjustments || returnRequest.nonReturnItemSubtotalAdjustment != 0}">
    <details class="roundedBox">
      ...
      <div>
        ...
        <c:if test="${returnRequest.nonReturnItemSubtotalAdjustment != 0}">
...
<%-- @version $Id: //hosting-blueprint/B2CBlueprint/version/11.2/Storefront/j2ee/store.war/mobile/myaccount/gadgets/refundPriceAdjustments.jsp#2 $$Change: 953229 $--%>
