      ...
      <dsp:oparam name="output">
        ...
        <dsp:droplet name="ForEach" array="${relatedReturnRequests}" elementName="return">
          <dsp:oparam name="output">
            ...
            <c:if test="${returnRequest.order.id == currentOrderId}">
              ...
              <span class="value">
                ...
                <dsp:a page="${mobileStorePrefix}/myaccount/returnDetail.jsp">
                  <dsp:param name="returnRequestId" value="${returnRequest.repositoryId}"/>
                    <c:out value="${returnRequest.repositoryId}"/> (<fmt:formatDate value="${returnRequest.createdDate}"
...
<%-- @version $Id: //hosting-blueprint/B2CBlueprint/version/11.2/Storefront/j2ee/store.war/mobile/myaccount/gadgets/orderDetailReturns.jsp#2 $$Change: 953229 $--%>
