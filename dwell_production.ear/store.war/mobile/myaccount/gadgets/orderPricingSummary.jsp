    ...
    <div class="discount">
      ...
      <c:forEach var="priceAdjustment" varStatus="status" items="${order.priceInfo.adjustments}" begin="1">
        <preview:repositoryItem item="${priceAdjustment.pricingModel}">
          ...
          <c:out value="${pricingModel.description}</br>" escapeXml="false"/>
...
<%-- @version $Id: //hosting-blueprint/B2CBlueprint/version/11.2/Storefront/j2ee/store.war/mobile/myaccount/gadgets/orderPricingSummary.jsp#1 $$Change: 946917 $--%>
