    ...
    <jsp:body>
      ...
      <div class="dataContainer">
        ...
        <dsp:form action="${pageContext.request.requestURI}" method="post" formid="profilePasswordEdit">
          ...
          <dsp:input bean="ProfileFormHandler.confirmPassword" type="hidden" value="true"  autocomplete="off"/>
            ...
            <li ${not empty errorMap['oldpassword'] || not empty errorMap['oldInvalid'] ? 'class="errorState"' : ''}>
              <div class="content">
                ...
                <dsp:input id="oldPassword" maxlength="35" bean="ProfileFormHandler.value.oldpassword"
                           type="password" required="true" value="" placeholder="${oldPasswordPlaceholder}" aria-label="${oldPasswordPlaceholder}" autocomplete="off"/>
            ...
            <li ${not empty errorMap['password'] || not empty errorMap['allEqual'] || not empty errorMap['requirements'] ? 'class="errorState"' : ''}>
              <div class="content">
                ...
                <dsp:input maxlength="35" bean="ProfileFormHandler.value.password"
                           type="password" required="true" value="" placeholder="${newPasswordPlaceholder}" aria-label="${newPasswordPlaceholder}" autocomplete="off"/>
              </div>
            ...
            <li ${not empty errorMap['confirmpassword'] || not empty errorMap['notMatching'] ? 'class="errorState"' : ''}>
              <div class="content">
                ...
                <dsp:input maxlength="35" bean="ProfileFormHandler.value.confirmpassword"
                           type="password" required="true" value="" placeholder="${confirmPasswordPlaceholder}" aria-label="${confirmPasswordPlaceholder}" autocomplete="off"/>
              </div>
          ...
          <div class="centralButton">
            ...
            <dsp:input bean="ProfileFormHandler.changePassword" class="mainActionButton" type="submit" value="${updateButton}" autocomplete="off"/>
          </div>
        </dsp:form>
      </div>
    </jsp:body>
...
<%-- @version $Id: //hosting-blueprint/B2CBlueprint/version/11.2/Storefront/j2ee/store.war/mobile/myaccount/profilePasswordEdit.jsp#2 $$Change: 953229 $--%>
