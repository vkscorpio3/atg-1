            ...
            <c:if test="${addrType == 'shipping' && addrOper == 'edit'}">
              <li>
                <div class="deleteContainer">
                  ...
                  <div role="button" onclick="${deletable ? 'CRSMA.common.removeItemDialog($(this).parent())' : 'CRSMA.myaccount.toggleCantDeleteAddressDialog()'}" title="${deleteText}" class="icon-Remove">
                    ${deleteText}
                  </div>
                </div>
              </li>
...
<%-- @version $Id: //hosting-blueprint/B2CBlueprint/version/11.2/Storefront/j2ee/store.war/mobile/address/myaccountAddressDetail.jsp#1 $$Change: 946917 $--%>
