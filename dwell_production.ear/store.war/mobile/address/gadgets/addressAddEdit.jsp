...
<dsp:page>
  ...
  <li ${not empty errorMap['city'] || not empty errorMap['state'] ? 'class="errorState"' : ''}>
    ...
    <%-- "State" --%>
    <div ${not empty errorMap['state'] ? 'class=errorState' : 'class=right'}>
  ...
  <li ${not empty errorMap['postalCode'] || not empty errorMap['country'] ? 'class="errorState"' : ''}>
    ...
    <%-- "Country" --%>
    <div ${not empty errorMap['country'] ? 'class=errorState' : 'class=right'}>
      <div class="content icon-ArrowLeft">
...
<%-- @version $Id: //hosting-blueprint/B2CBlueprint/version/11.2/Storefront/j2ee/store.war/mobile/address/gadgets/addressAddEdit.jsp#1 $$Change: 946917 $--%>
