...
<dsp:page>
  ...
  <fmt:message var="pageTitle" key="mobile.moreInfo.languages"/>
                      ...
                      <li>
                        <div class="content">
                          <input name="language" id="lang_${languageStatus.index}" type="radio"
                                 onclick="CRSMA.common.gotoURL(this.value);" value="${language.linkURL}" ${isSelected}/>
...
<%-- @version $Id: //hosting-blueprint/B2CBlueprint/version/11.2/Storefront/j2ee/store.war/mobile/company/languages.jsp#1 $$Change: 946917 $ --%>
