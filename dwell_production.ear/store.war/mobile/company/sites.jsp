...
<dsp:page>
  ...
  <fmt:message var="pageTitle" key="mobile.common.label.site"/>
        ...
        <dsp:oparam name="output">
          ...
          <c:if test="${fn:length(sites) > 0}">
            <div class="dataContainer">
              <div class="basicText">
                <fmt:message key="mobile.company.sites.pageHeader"/>
              </div>
                    ...
                    <li>
                      ...
                      <div class="content">
                        <input type="radio" id="curSite${siteIdx}" name="site" ${isChecked}
                               onclick="setTimeout(function() {CRSMA.common.gotoURL('${siteLinkUrl}')}, 300);"/>
...
<%-- @version $Id: //hosting-blueprint/B2CBlueprint/version/11.2/Storefront/j2ee/store.war/mobile/company/sites.jsp#1 $$Change: 946917 $--%>
