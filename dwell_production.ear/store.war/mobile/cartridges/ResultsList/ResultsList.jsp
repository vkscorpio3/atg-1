    ...
    <ul class="searchResults">
      <c:choose>
        <c:when test="${empty totalNumRecords || totalNumRecords == 0}">
          <%-- No search results --%>
          <li></li>
          <li><h2><fmt:message key="mobile.resultsList.noResults"/></h2></li>
          <li></li>
        </c:when>
        <c:otherwise>
...
<%-- @version $Id: //hosting-blueprint/B2CBlueprint/version/11.2/Storefront/j2ee/store.war/mobile/cartridges/ResultsList/ResultsList.jsp#1 $$Change: 946917 $--%>
