...
<dsp:page>
  ...
  <c:if test="${lastRecordIndex < totalNumRecords}">
    ...
    <li class="moreResults" onclick="CRSMA.search.getItems('${url}');">
      <span role="link">
        <fmt:message key="mobile.resultsList.button.showMore"><fmt:param value="${remainingResults}"/></fmt:message>
      </span>
    </li>
  </c:if>
</dsp:page>
<%-- @version $Id: //hosting-blueprint/B2CBlueprint/version/11.2/Storefront/j2ee/store.war/mobile/cartridges/LocationResultsList/storeListRangePagination.jsp#1 $$Change: 953229 $--%>
