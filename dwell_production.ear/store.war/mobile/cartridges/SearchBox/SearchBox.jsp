    ...
    <script>
      $(document).ready(function(event) {
        CRSMA.autosuggest.init({
          ...
          collection: "${contentItem.contentPaths[0]}",
          containerClass: "dimSearchSuggContainer",
          siteContextPath: "${siteContextPath}${navigationActionPath}"
        });
      });
    </script>
  </c:if>
</dsp:page>
<%-- @version $Id: //hosting-blueprint/B2CBlueprint/version/11.2/Storefront/j2ee/store.war/mobile/cartridges/SearchBox/SearchBox.jsp#2 $$Change: 953229 $--%>
