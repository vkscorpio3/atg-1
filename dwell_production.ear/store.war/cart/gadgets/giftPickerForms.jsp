<%--
  ...
  Required parameters:
    ...
    promotionId
	  Specifies currently applied promotion.
...
<%-- @version $Id: //hosting-blueprint/B2CBlueprint/version/11.2/Storefront/j2ee/store.war/cart/gadgets/giftPickerForms.jsp#2 $$Change: 953229 $--%>
