...
<dsp:page>
  ...
  <div class="atg_store_cartActions">
    ...
    <%-- 
      ...
      be to the users last browsed category, or to '/home' if this doesn't exist or is not valid 
...
<%-- @version $Id: //hosting-blueprint/B2CBlueprint/version/11.2/Storefront/j2ee/store.war/cart/gadgets/actionItems.jsp#1 $$Change: 946917 $--%>
