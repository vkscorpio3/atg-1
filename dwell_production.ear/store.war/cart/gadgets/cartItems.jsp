                            ...
                            <c:otherwise>
                              <fieldset>
                                <input class="text qty atg_store_numericInput" type="text" 
                                       ...
                                       targetButton="atg_store_update_${count}">
        
                                <fmt:message var="updateItemText" key="common.button.updateItemText"/>
                                
                                <dsp:input id="atg_store_update_${count}" iclass="atg_store_textButton" type="submit"
                        ...
                        <c:otherwise>
                          <fieldset>
                            <input class="text qty atg_store_numericInput" type="text" 
                                   ...
                                   value="<dsp:valueof param='currentItem.quantity'/>" 
                                   dojoType="atg.store.widget.enterSubmit" targetButton="atg_store_update_${count}">
...
<%-- @version $Id: //hosting-blueprint/B2CBlueprint/version/11.2/Storefront/j2ee/store.war/cart/gadgets/cartItems.jsp#2 $$Change: 1179550 $--%>
