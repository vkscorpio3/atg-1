...
<dsp:page>
  ...
  <dsp:droplet name="StorePriceBeansDroplet">
    ...
    <dsp:oparam name="output">
      ...
      <dsp:getvalueof var="priceBeans" vartype="java.lang.Object" param="priceBeans"/>
      
      <c:forEach var="unitPriceBean" items="${priceBeans}" varStatus="unitPriceBeanStatus">
        ...
        <%-- 
         ...
         <c:if test="${not empty pricingModels}">
   		...
   		<dsp:getvalueof var="priceBeansQuantity" vartype="java.lang.Object" param="priceBeansQuantity"/>
   		<dsp:getvalueof var="gwpPriceBeansQuantity" vartype="java.lang.Object" param="gwpPriceBeansQuantity"/>
   		
        <c:if test="${displayPrice}">   
          <dsp:include page="displayItemPrice.jsp">
            <dsp:param name="quantity" value="${unitPriceBean.quantity}"/>
            <dsp:param name="displayQuantity" value="${priceBeansQuantity - gwpPriceBeansQuantity > 1}"/>
...
<%-- @version $Id: //hosting-blueprint/B2CBlueprint/version/11.2/Storefront/j2ee/store.war/cart/gadgets/detailedItemPrice.jsp#1 $$Change: 946917 $--%>