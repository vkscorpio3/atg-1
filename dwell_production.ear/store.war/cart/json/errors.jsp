...
<%--
  This page renders any CartModifierFormHandler formExceptions.
...
<dsp:page>
  ...
  <json:object>
    ...
    <json:property name="errorUrl" escapeXml="false">
      <dsp:valueof bean="/atg/commerce/order/purchase/CartModifierFormHandler.addItemToOrderErrorURL" valueishtml="true"/>
    </json:property>
    <json:array name="errors">   
      ...
      <dsp:droplet name="ErrorMessageForEach">
        <dsp:param param="/atg/commerce/order/purchase/CartModifierFormHandler.formExceptions" name="exceptions"/>        
...
<%-- @version $Id: //hosting-blueprint/B2CBlueprint/version/11.2/Storefront/j2ee/store.war/cart/json/errors.jsp#1 $$Change: 946917 $--%>
