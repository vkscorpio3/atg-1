...
<dsp:page>
  ...
  <%--
    ...
    Open Parameters:
      true
        Serviced when a removed item is found in the current order.
      false
        Serviced when a removed item is NOT found in the current order.
  --%>
...
<%-- @version $Id: //hosting-blueprint/B2CBlueprint/version/11.2/Storefront/j2ee/store.war/cart/json/cartContents.jsp#1 $$Change: 946917 $--%>
