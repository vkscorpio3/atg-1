                  ...
                  <dd>
                    ...
                    <dsp:droplet name="PropertyValueCollection">
                      ...
                      <dsp:oparam name="error">
                        <%--
                          Getting an error when a product doesn't have a particular
                          sku, PropertyValueCollection should really handle better
                          and return empty
                        --%>
...
<%-- @version $Id: //hosting-blueprint/B2CBlueprint/version/11.2/Storefront/j2ee/store.war/comparisons/gadgets/productChildDisplay.jsp#2 $$Change: 1179550 $--%>
