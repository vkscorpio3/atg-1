          ...
          <c:forEach var="productListItem" items="${productListItems}" varStatus="status">
            ...
            <td class="atg_store_compareFeatures atg_store_compareItemDetails" >
              ...
              <dd>
                ...
                <c:choose>
                  <c:when test="${empty productFeatures}">
...
<%-- @version $Id: //hosting-blueprint/B2CBlueprint/version/11.2/Storefront/j2ee/store.war/comparisons/gadgets/productFeatures.jsp#2 $$Change: 1179550 $--%>
