            ...
            <dsp:oparam name="outputStart">
              ...
              <table valign="top" id="atg_store_itemTable" class="atg_store_myWishListTable" summary="${tableSummary}" cellspacing="0" cellpadding="0">
                <thead>
                  <tr>
                    <%--
                      Display site indicator only for sites that share atg.ShoppingCart shareable,
...
<%-- @version $Id: //hosting-blueprint/B2CBlueprint/version/11.2/Storefront/j2ee/store.war/myaccount/myWishList.jsp#1 $$Change: 946917 $--%>
