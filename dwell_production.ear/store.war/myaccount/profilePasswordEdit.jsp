              ...
              <ul class="atg_store_basicForm">
                <li>
                  ...
                  <dsp:input bean="ProfileFormHandler.value.oldpassword" maxlength="35"
                             ...
                             id="atg_store_profilePasswordEditOldPassword" autocomplete="off"/>
                </li>
                <li>
                  ...
                  <dsp:input bean="ProfileFormHandler.value.password" maxlength="35"
                             ...
                             id="atg_store_profilePasswordEditNewPassword" autocomplete="off"/>
                ...
                <li>
                  ...
                  <dsp:input bean="ProfileFormHandler.value.confirmpassword" maxlength="35"
                             ...
                             id="atg_store_profilePasswordEditRetypePassword" autocomplete="off"/>
                </li>
              </ul>
            </fieldset>
                ...
                <div class="atg_store_formActionItem">
                  <span class="atg_store_basicButton">
                    <dsp:input bean="ProfileFormHandler.changePassword"
                               ...
                               id="atg_store_profilePasswordEditSubmit" autocomplete="off"/>
                  </span>
                </div>
...
<%-- @version $Id: //hosting-blueprint/B2CBlueprint/version/11.2/Storefront/j2ee/store.war/myaccount/profilePasswordEdit.jsp#2 $$Change: 953229 $--%>
