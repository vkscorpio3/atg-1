      ...
      <div class="atg_store_main atg_store_myAccount atg_store_myReturnItemSelection">
        ...
        <c:choose>
          ...
          <c:otherwise>
            ...
            <fmt:message var="errorMsg" key="myaccount_returnItemsSelect_noOrderIdReceivedError"/>
...
<%-- @version $Id: //hosting-blueprint/B2CBlueprint/version/11.2/Storefront/j2ee/store.war/myaccount/returnItemsSelection.jsp#1 $$Change: 946917 $--%>