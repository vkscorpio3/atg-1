            ...
            <table class="atg_store_myOrdersTable atg_store_dataTable" border="0" summary="${tableSummary}" cellspacing="0" cellpadding="0">
              ...
              <tbody>
                ...
                <%-- 
                  ...
                  --%>
                <c:forEach var="returnRequest" items="${returns}" varStatus="status">
...
<%-- @version $Id: //hosting-blueprint/B2CBlueprint/version/11.2/Storefront/j2ee/store.war/myaccount/myReturns.jsp#1 $$Change: 946917 $--%>
