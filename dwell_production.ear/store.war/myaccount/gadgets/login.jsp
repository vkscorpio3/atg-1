        ...
        <dsp:form action="${originatingRequest.requestURI}" method="post" 
          ...
          <c:choose>
            ...
            <c:otherwise>
              <dsp:input bean="ProfileFormHandler.loginSuccessURL" 
                         type="hidden" value="../home?locale=${currentLocale}"/>
            </c:otherwise>
          </c:choose>
          ...
          <li>
            ...
            <dsp:input bean="ProfileFormHandler.value.password" iclass="text"
                       ...
                       id="atg_store_registerLoginPassword" autocomplete="off"/>
...
<%-- @version $Id: //hosting-blueprint/B2CBlueprint/version/11.2/Storefront/j2ee/store.war/myaccount/gadgets/login.jsp#2 $$Change: 953229 $--%>
