<%--
  This page displays input field for email address and 
...
<dsp:page>
  ...
  <div id="atg_store_profilePasswordForgot">
    <dsp:form action="${originatingRequest.requestURI}" 
              method="post" id="atg_store_profilePasswordForgotForm" 
              formid="atg_store_profilePasswordForgotForm">
      
      <%-- 
        If password has been sent successfully redirect 
        to the tempPasswordSent page  
      --%>        
      ...
      <%--
        If password hasn't been sent redirect to the passwordReset page
       --%>                 
      ...
      <ul class="atg_store_basicForm">
        <li>
          ...
          <dsp:input type="text" bean="ForgotPasswordHandler.value.email" 
                     maxlength="255" required="true"
                     name="atg_store_profilePasswordForgotEmail" 
                     iclass="required"
      ...
      <div class="atg_store_formFooter">
        ...
        <div class="atg_store_formActions">
          ...
          <span class="atg_store_basicButton atg_store_emailMe">
            <dsp:input bean="ForgotPasswordHandler.forgotPassword" 
                       type="submit" 
                       name="atg_store_profilePasswordForgotSubmit"
...
<%-- @version $Id: //hosting-blueprint/B2CBlueprint/version/11.2/Storefront/j2ee/store.war/myaccount/gadgets/profilePasswordForgot.jsp#1 $$Change: 946917 $--%>
