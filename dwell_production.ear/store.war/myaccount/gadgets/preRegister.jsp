<%--
  This gadget is used on login page and provide an ability to 
  enter email address for new customers. If address is valid,
  registration continues on the registration page.
...
<dsp:page>
  ...
  <div class="atg_store_loginMethod" id="atg_store_newCustomerPreLogin">
    <h2>
      <span class="open">
    ...
    <dsp:form method="post" action="${originatingRequest.requestURI}" 
      ...
      <%-- 
        If email validation succeeds, go to the registration page 
        and continue fill in required information
       --%>
      <dsp:input bean="RegistrationFormHandler.preRegisterSuccessURL" 
                 type="hidden" value="registration.jsp"/>
      
      <%-- 
        If validation fails, redisplay login page with errors shown 
        --%>
      <dsp:input bean="RegistrationFormHandler.preRegisterErrorURL" 
      ...
      <ul class="atg_store_basicForm">
        ...
        <li>
          ...
          <dsp:input bean="RegistrationFormHandler.value.email" 
                     iclass="text" type="text" maxlength="255"
        ...
        <div class="atg_store_formActions">
          <span class="atg_store_basicButton atg_store_chevron">
            <dsp:input bean="RegistrationFormHandler.preRegister" type="submit" 
                       ...
                       id="atg_store_createAccountButton"/>
          </span>    
        </div>
...
<%-- @version $Id: //hosting-blueprint/B2CBlueprint/version/11.2/Storefront/j2ee/store.war/myaccount/gadgets/preRegister.jsp#1 $$Change: 946917 $--%>