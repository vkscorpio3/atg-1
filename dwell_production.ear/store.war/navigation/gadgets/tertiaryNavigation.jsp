  ...
  <div id="atg_store_tertiaryNavigation">
     <ul>
        ...
        <li>
          ...
          <dsp:a page="${actionPath}" title="${linkText}">            
            <c:out value="${linkText}"/>
          </dsp:a>
        </li>
...
<%-- @version $Id: //hosting-blueprint/B2CBlueprint/version/11.2/Storefront/j2ee/store.war/navigation/gadgets/tertiaryNavigation.jsp#1 $$Change: 946917 $ --%>
