<%--
  Initalizes the Rich Cart in the navigation menu. The rich cart will display
  the contents of a users cart.
  ...
  <script type="text/javascript">
    dojo.addOnLoad(function(){
      ...
      var triggerWidget=new atg.store.widget.RichCartTrigger({
        id:"richCartTrigger",
        containerNodeId:"atg_store_richCartTarget",
      ...
      <%-- Create the rich cart widget itself --%>
      var richCartWidget=new atg.store.widget.RichCartSummary({
        ...
        data: <dsp:include page="/cart/json/cartContents.jsp"/>,
        ...
        onSetAllCartData: function() {
          if(window.atgPreviewSupport)
            window.atgPreviewSupport.updatePreviewInfo();
        }
      });
...
<%-- @version $Id: //hosting-blueprint/B2CBlueprint/version/11.2/Storefront/j2ee/store.war/navigation/gadgets/richCart.jsp#1 $$Change: 946917 $--%>
