...
<dsp:page>
  ...
  <div id="atg_store_personalNav">
    <ul id="atg_store_personalNavItems">        
      ...
      <fmt:message var="itemLabel" key="navigation_personalNavigation.storeLocator"/>
        ...
        <dsp:a id="storeLocation" page="${actionPath}" title="${itemTitle}" iclass="atg_store_navLocation">          
...
<%-- @version $Id: //hosting-blueprint/B2CBlueprint/version/11.2/Storefront/j2ee/store.war/navigation/gadgets/personalNavigation.jsp#1 $$Change: 946917 $ --%>
