  ...
  <c:forEach var="navItem" items="${navHistory}" varStatus="status">
    ...
    <c:choose>
      <c:when test="${status.first}">
        ...
        <dsp:a page="/home" iclass="atg_store_navLogo">
...
<%-- @version $Id: //hosting-blueprint/B2CBlueprint/version/11.2/Storefront/j2ee/store.war/navigation/gadgets/breadcrumbs.jsp#1 $$Change: 946917 $--%>
