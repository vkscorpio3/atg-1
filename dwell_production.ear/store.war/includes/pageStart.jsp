...
<dsp:page>
  ...
  <%--
    Only include the DOCTYPE, HTML and HEAD tags if they have NOT already been
    included by endecaSlot.jspf.
    NOTE: when making changes to the DOCTYPE or HTML tag also make those changes 
    in endecaSlot.jspf
  --%>
...
<%-- @version $Id: //hosting-blueprint/B2CBlueprint/version/11.2/Storefront/j2ee/store.war/includes/pageStart.jsp#2 $$Change: 953229 $--%>
