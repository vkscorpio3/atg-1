...
<dsp:page>
  ...
  <dsp:getvalueof var="isTransient" vartype="java.lang.String" bean="Profile.transient"/>
  
  <c:if test='${isTransient == "true"}'>
...
<%-- @version $Id: //hosting-blueprint/B2CBlueprint/version/11.2/Storefront/j2ee/store.war/checkout/confirmResponse.jsp#2 $$Change: 953229 $--%>
