                      ...
                      <ul class="atg_store_basicForm">
                        ...
                        <li>
                          ...
                          <dsp:input bean="CheckoutProfileFormHandler.value.password" type="password" 
                                     name="password" id="atg_store_passwordInput" value="" autocomplete="off"/>
...
<%-- @version $Id: //hosting-blueprint/B2CBlueprint/version/11.2/Storefront/j2ee/store.war/checkout/login.jsp#2 $$Change: 953229 $--%>