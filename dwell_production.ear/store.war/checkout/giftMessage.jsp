                ...
                <dsp:droplet name="ProfileSecurityStatus">
                  <dsp:oparam name="anonymous">
                    ...
                    <dsp:input type="hidden" 
                               bean="GiftMessageFormHandler.sessionExpirationURL" 
                               value="${originatingRequest.contextPath}/home"/>
                  </dsp:oparam>
                  <dsp:oparam name="default">
                    <dsp:input type="hidden" 
                               bean="GiftMessageFormHandler.sessionExpirationURL" 
...
<%-- @version $Id: //hosting-blueprint/B2CBlueprint/version/11.2/Storefront/j2ee/store.war/checkout/giftMessage.jsp#1 $$Change: 946917 $--%>
