            ...
            <dsp:droplet name="TargetingFirst">
              ...
              <dsp:oparam name="output">
                ...
                <dsp:include page="/emailtemplates/gadgets/emailSiteLinkDisplay.jsp">
                  <dsp:param name="path" value="/home"/>
...
<%-- @version $Id: //hosting-blueprint/B2CBlueprint/version/11.2/Storefront/j2ee/store.war/emailtemplates/abandonedOrderPromo.jsp#1 $$Change: 946917 $--%>