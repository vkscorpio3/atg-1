...
<dsp:page>
  ...
  <table style="border-collapse:collapse;font-family:Tahoma,Arial,sans-serif">
  
    <%-- Display Refund Summary header. --%>
    <tr>
      <td colspan="2">
        <span style="font-size:14px;font-size:18px"><fmt:message key="emailtemplates_refundSummary_title"/><fmt:message key="common.labelSeparator"/></span>
        <br /><br />
      </td>
    </tr>
...
<%-- @version $Id: //hosting-blueprint/B2CBlueprint/version/11.2/Storefront/j2ee/store.war/emailtemplates/gadgets/emailRefundSummary.jsp#1 $$Change: 946917 $--%>