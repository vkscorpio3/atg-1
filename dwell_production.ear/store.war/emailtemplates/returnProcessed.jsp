<%--
  Return processed email template. Contains return details including items returned, quantity,
...
<dsp:page>
  ...
  <%-- Email subject --%>
  <fmt:message var="emailSubject" key="emailtemplates_returnProcessed.subject">
    <fmt:param>
  ...
  <%-- Email title --%>
  <fmt:message var="emailTitle" key="emailtemplates_returnProcessed.title">
    <fmt:param>
      <dsp:valueof bean="Site.name" />
    </fmt:param>
  </fmt:message>
...
<%-- @version $Id: //hosting-blueprint/B2CBlueprint/version/11.2/Storefront/j2ee/store.war/emailtemplates/returnProcessed.jsp#1 $$Change: 946917 $--%>