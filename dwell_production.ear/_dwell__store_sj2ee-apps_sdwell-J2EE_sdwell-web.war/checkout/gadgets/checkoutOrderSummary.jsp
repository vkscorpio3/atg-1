  ...
  <div class="atg_store_orderSummary aside">
    ...
    <ul class="atg_store_orderSubTotals">
      ...
      <dsp:droplet name="ShippingPromotionsDroplet">
        ...
        <li>
          <span class="atg_store_orderSummaryLabel">
            <fmt:message key="common.shipping"/><c:out value="${not empty shippingPromotions?'**':''}"/>
          </span>
          <span class="atg_store_orderSummaryItem">
            <dsp:include page="/global/gadgets/formattedPrice.jsp">
...
<%-- @version $Id: //hosting-blueprint/B2CBlueprint/version/11.2/Storefront/j2ee/store.war/checkout/gadgets/checkoutOrderSummary.jsp#2 $$Change: 1179550 $--%>
