...
<dsp:page>
  ...
  <ul class="atg_store_basicForm atg_store_addNewCreditCard">
    ...
    <li class="atg_store_saveCC option" style="${isTransient ? 'display: none;' : ''}">
     
      <dsp:input type="checkbox" bean="BillingFormHandler.saveCreditCard" name="addCard" 
                 iclass="checkbox" checked="${!isTransient}" id="atg_store_ccAddSaveccInput"/> 
...
<%-- @version $Id: //hosting-blueprint/B2CBlueprint/version/11.2/Storefront/j2ee/store.war/checkout/gadgets/creditCardForm.jsp#2 $$Change: 953229 $--%>
