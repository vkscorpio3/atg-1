...
<dsp:input bean="CreateHardgoodShippingGroupFormHandler.newHardgoodShippingGroup" type="submit" value="Proceed to Billing"/>
<dsp:input bean="CreateHardgoodShippingGroupFormHandler.newHardgoodShippingGroupSuccessURL" type="hidden" value="billing.jsp"/>
<dsp:input bean="CreateHardgoodShippingGroupFormHandler.newHardgoodShippingGroupErrorURL" type="hidden" value="shipping.jsp"/>  </td>  </tr>
</dsp:form>
</table>
