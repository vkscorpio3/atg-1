...
<tr>  <td>MiddleName:</td>  <td><dsp:input
bean="CreateCreditCardFormHandler.creditCard.billingAddress.middleName"
beanvalue="Profile.middleName" size="30" type="text"/></td>  </tr>
...
type="hidden" value="expresscheckout.jsp?init=true"/>
<dsp:input bean="CreateCreditCardFormHandler.newCreditCardErrorURL"
type="hidden" value="expresscheckout.jsp"/>
